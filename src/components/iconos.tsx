// Iconos en SVG inline. Sin librería: son pocos y así no cargamos un paquete
// entero para seis dibujos.
...
export function IconoCheck({ className = "h-5 w-5" }: Props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function IconoUbicacion({ className = "h-5 w-5" }: Props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function IconoTarjeta({ className = "h-5 w-5" }: Props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function IconoCamion({ className = "h-5 w-5" }: Props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      ...
      aria-hidden="true"
    >
      <path d="M1 7h12v9H1zM13 10h4l3 3v3h-7z" />
...
/** Selector por nombre, para poder listar las redes desde la configuración. */
export const ICONOS_RED: Record<string, (p: Props) => React.ReactElement> = {
  instagram: IconoInstagram,
  facebook: IconoFacebook,
  whatsapp: IconoWhatsApp,
};

export function IconoImagen({ className = "h-5 w-5" }: Props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
